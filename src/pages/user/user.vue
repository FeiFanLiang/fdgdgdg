<template lang="html">
    <div id="user-page">
      ...
      <el-col :span="4">
        ...
        <el-table :data="list" ref="table" style="width: 100%" element-loading-text="拼命加载中" v-loading="loading" border @expand="getRoleList" row-key="UserName" :expand-row-keys="expandRowKeys">
                ...
                <template scope="props">
                    <el-form label-position="left" inline>
                        <el-form-item id="roleLabel" v-loading.body="loading2">
                            ...
                            <div>
                                <el-autocomplete class="myinput" :icon="roles?'check':'close'" popper-class="my-autocomplete" custom-item="my-item-zh" v-model="roles" :fetch-suggestions="querySearch" ref="saveTagInput" v-if="inputVisible" placeholder="请选择角色" :on-icon-click="handleIconClick">
                                </el-autocomplete>
