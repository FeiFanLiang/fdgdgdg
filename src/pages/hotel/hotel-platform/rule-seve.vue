...
<div id="Rule">
    ...
    <el-table :data="RuleCheck" style="width: 100%" border element-loading-text="拼命加载中" v-loading="loading"
     row-key="ID"  ref="table">
        <el-table-column label="优先级" prop="Rank" sortable ></el-table-column>     
        <el-table-column label="渠道" prop="PlatName" width=170>
        ...
        <el-table-column label="预定天数" prop="BookDay" show-overflow-tooltip></el-table-column>
        ...
        <el-table-column label="开始天数" prop="StartDay"></el-table-column>
        <el-table-column label="结束天数" prop="EndDay"></el-table-column>
      ...
      <el-col :span="12">        
        ...
        <el-form-item label="结束日期" prop="EndDate">
         ...
         <el-form-item label="选择模式" prop='StateCheck'>
          <el-select v-model="form.StateCheck" placeholder="请选择" clearable>
              <el-option v-for="(item,index) in StateCheck" :label="item.label" :value="item.value"></el-option>
          </el-select>
        </el-form-item>
