                ...
                <el-form-item>
                    <el-radio-group v-model="form.radio">
                        <el-radio class="radio" label="1">
                            <span class="radioText1">折扣券</span>
                            <br>
                            <span class="radioText2">可为用户提供消费折扣，支持优惠抵扣快速买单</span>
                        </el-radio>
                        <br>
                        <el-radio class="radio" label="2">
                            <span class="radioText1">代金券</span>
                            <br>
                            <span class="radioText2">可为用户提供抵扣现金服务。可设置成为“满*元，减*元”，支持优惠抵扣快速买单</span>
                        </el-radio>
                        <br>
                        <el-radio class="radio" label="3">
                            <span class="radioText1">兑换券</span>
                            <br>
                            <span class="radioText2">可为用户提供消费送赠品服务</span>
                        </el-radio>
                        <br>
                        <el-radio class="radio" label="4">
                            <span class="radioText1">团购券</span>
                            <br>
                            <span class="radioText2">可为用户提供团购套餐服务</span>
                        </el-radio>
                        <br>
                        <el-radio class="radio" label="5">
                            <span class="radioText1">优惠券</span>
                            <br>
                            <span class="radioText2">即“通用券”，建议当以上四种无法满足需求时采用</span>
                        </el-radio>
                        <br>
                    </el-radio-group>
                </el-form-item>
